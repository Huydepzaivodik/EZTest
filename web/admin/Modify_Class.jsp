...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="modifyClass" method="post" onsubmit="return validateForm()">      
                <div class="mb-3">
                    <label for="class_name" class="form-label"><b>Class Name</b></label>
                    <input type="text" class="form-control" name="class_name" id="class_name" value="${error != null ? param.class_name : class_name}">
                    <span style="font-size: small; color: red" id="class_name_update">${error}</span>
                </div> 
                <div class="mb-3">
                    <label for="teacher_id" class="form-label"><b>Select New Teacher</b></label>
                    <select class="form-control" name="teacher_id" id="teacher_id" value="${teacher_id}">
                ...
                <div class="mb-3">
                    <label for="alter_teacher_id" class="form-label"><b>2nd Teacher (read only)</b></label>
                    <input type="text" class="form-control" name="alter_teacher_id" value="${alter_teacher_id}" readonly>
                </div>
                <input type="hidden" name="class_id" value="${class_id}">
                <input type="hidden" name="alter_teacher_id" value="${alter_teacher_id}">
