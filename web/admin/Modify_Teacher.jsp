                                                ...
                                                <form action="modify" method="post">
                                                                ...
                                                                <div class="col">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control" name="gender">
                                                                            ...
                                                                            <option value="female" ${gender == 'feeacher.isGender()male' ? 'selected' : ''}>Female</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="col">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="form-inline" style="display:flex;align-items: center">
                                                                            <input class="form-control" style="width: 300px" type="text" name="preEmail" value="${errorMessage4 != null ? param.preEmail : username}">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col d-flex justify-content-end">
                                                            <button class="btn btn-primary" style="color: #EDF5E1;" type="submit" name="mod"  value="updateTea">Save Changes</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
