        ...
        <script>
            ...
            function startCountdown() {
                ...
                countdownInterval = setInterval(function () {
                    if (countdownMinutes === 0 && countdownSeconds === 0) {
                        ...
                        window.location.href = "calScore?student_id=" + studentId + "&quiz_id=" + quizId + "&course_id=" + courseId + "&endTime=" + endTime + "&startTime=" + startTime;
                    } else {
            ...
            function submitExam() {
                ...
                if (confirmed) {
                    ...
                    var student_id = studentId;  // Thay thế bằng giá trị thực tế
                    var quiz_id = quizId;    // Thay thế bằng giá trị thực tế

                    window.location.href = "calScore?student_id=" + student_id + "&quiz_id=" + quiz_id + "&course_id=" + courseId + "&endTime=" + endTime + "&startTime=" + startTime;
