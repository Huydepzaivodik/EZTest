...
<html lang="en">
    ...
    <body>
        <%
            ...
            Account teacher = (Account) request.getAttribute("teacher");
        %>
        ...
        <a href="studentViewClass?course_id=${course_id}" class="back-link"><b>Back</b></a>
        <%} else if(role.equals("Admin")){%>
        <a href="viewClass?course_id=${course_id}" class="back-link"><b>Back</b></a>
        <%}%>
                                    ...
                                    <div class="table-responsive">
                                        <form action="updatePhone" method="post" onsubmit="return validateForm()">
                                            <table class="table">
                                                ...
                                                <td class="col-md-9 text-left input"><%=teacher.getPhone()%></td>
                                                </td>
                                                </tr>
                                                </tbody>
                                            </table>
