            ...
            <section class="py-4">
                <div class="container">
                    ...
                    <div class="list-course row">
                        ...
                        <c:forEach begin="${startIndex}" end="${endIndex}" items="${classList}" var="cl">
                            <div class="col-md-6 col-xl-4">
                                <div class="image-box image-box--shadowed white-bg style-2 mb-4" style="border-radius: 15px;">
                                    <div class="body">
                                        <h4><a href="teacherViewQuiz?class_id=${cl.getClass_id()}">${cl.getClass_name()}</a></h4>                                      
                                        <div class="row d-flex align-items-center">
                                            <div class="col-10">
                                                <ul class="bottom-course-sum none-list">
                                                    <li><b>Class ID:</b>&nbsp;${cl.getClass_id()}</li>
                                                    <li><b>Course ID:</b>&nbsp;${cl.getCourse_id().getCourse_id()}</li>                                        
                                                    <li><b>Status:</b>&nbsp; ${cl.isStatus()}</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="pagination" >
                            <c:if test="${currentPage > 1}">
                                <a class="prev" href="teacherViewClass?course_id=${course_id}?page=${currentPage - 1}">Previous</a>
                            </c:if>
                            <c:if test="${endIndex < classList.size()}">
                                <a class="next" href="teacherViewClass?course_id=${course_id}?page=${currentPage + 1}">Next</a>
                            </c:if>
                        </div>
                    </div>
                </div>
