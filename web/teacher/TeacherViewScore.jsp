...
<html>
    ...
    <body>
        ...
        <a href="teacherViewQuiz?class_id=${class_id}" class="back-link btn btn-primary" style="margin-left: 710px; text-decoration: none"><b>Back</b></a>
        ...
        <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
            ...
            <h5 style="color: red" id="avarageScore"></h5>
        ...
        <script>                                                                
            ...
            var averagePoint = (10 / numberQuestion).toFixed(2)+' pts';                                                                                      

            // Lấy thẻ h5 theo id
            var h5Element = document.getElementById("avarageScore");

            // Cập nhật nội dung của thẻ h5 với giá trị đã làm tròn
            h5Element.textContent = "Average Point Of Question: " + averagePoint;
            ...
            var seconds = (time_taken_seconds % 60);
