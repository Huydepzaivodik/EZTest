...
<html lang="en">
    ...
    <body>
        <%
            ...
            Account student = (Account) request.getAttribute("student");
        %>
        ...
        <a href="viewListStuInClass?class_id=${class_id}" class="back-link"><b>Back</b></a>
                        ...
                        <div class="panel panel-info shadow">
                            <div class="panel-heading">
                                <h3 class="panel-title" style="color: #05386B">
                                    <img width="150" width="150" class="img-circle img-thumbnail" src="<%=student.getImg()%>">
                                    <%=student.getName()%>
                                </h3>
                            </div>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="col-md-9 text-left input"><%=(student.isGender()==true) ? "Male" : "Female" %></td>      
                                                        <% } else if (student.isGender() == false) { %>
                                                        <td class="col-md-3"><i class="icon-cog blackiconcolor fa fa-universal-access" aria-hidden="true"></i> <strong class="text"> Gender</strong></td>
                                                        <td class="col-md-9 text-left input"><%=(student.isGender()==true) ? "Male" : "Female" %></td>
                                                        <% } %>
                                                    </tr>
                                                ...
                                                <td class="col-md-9 text-left input"><%=student.getPhone()%></td>
                                                </td>
                                                </tr>
                                                </tbody>
                                            </table>
