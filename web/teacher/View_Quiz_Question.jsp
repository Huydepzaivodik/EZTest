                    ...
                    <div class="author-card pb-3">
                        ...
                        <div class="author-card-profile">
                            <div class="author-card-details">
                                <input class="author-card-name form-control" name="quiz_name" value="${quiz_name}" readonly>
                            ...
                            <a class="list-group-item ">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <input type="datetime-local" value="${start_time}" name="start_time" readonly
                                               class="form-control">
                            ...
                            <a class="list-group-item ">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <input type="datetime-local" value="${due_date}" name="due_date" readonly
                                               class="form-control">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <div class="d-inline-block  "><i
                                            ...
                                            <input type="checkbox" name="isVisible" value="true" style="margin: 12 0 10 0" class="form-check-input" disabled
                                                   <c:if test="${isDisplayDetail eq 'true'}">checked = "checked"</c:if>>
                                            </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <div class="d-inline-block  ">
                                                ...
                                                <input type="checkbox" name="isDisplayDetail" value="true" disabled <c:if test="${isDisplayDetail eq 'true'}">checked</c:if> class="form-check-input">
                                            </div>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <a class="list-group-item ">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="align-items-center">
                                            ...
                                            <select name="unit" class="form-control ml-2" disabled>
                                            ...
                                            <input type="number" placeholder="Duration" min="1" max="9000"
                                                   class="form-control" value="${duration}" name="duration" readonly>
